...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-100 py-0 flex flex-col ">
//       <div className=" items-center justify-center mx-auto mt-10 mb-6 w-[90vw]">
//         {/* max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-6 flex */}
//         {/* Navigation Card */}
//         {/* <Card className="shadow-md rounded-2xl flex">
...
//     <ul className="flex justify-between w-full max-w-4xl">
// <li className="pointer font-bold" onClick={() => navigate("Home")}>🏠 Home</li>
// <li className="pointer font-bold"  onClick={() => navigate("/Patient Info")}>📋 Patient Info</li>
// <li className="pointer font-bold"  onClick={() => navigate("/ Status Update")}>🔁 Status Update</li>
...
//           <CardContent className=" overflow-x-auto  items-center ">
//             <h2 className="text-xl font-bold text-blue-700 mb-4">
//               All Patients
//             </h2>
//             {patients.length === 0 ? (
...
//             ) : (
//               <table className=" table-auto border border-gray-200 text-sm w-[90vw]">
//                 <thead>
