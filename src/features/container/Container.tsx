    ...
    <div className="flex flex-col md:flex-row items-center justify-between p-8  min-h-screen">
      <div className=" md:w-1/2 mb-8 mb:mb-0 text-center md:text-left ">
        ...
        <div className='flex flex-col items-center justify-center'>
          <p className="font-semibold p-7 text-zinc-600 text-xl italic">“Our Surgery Status Board helps hospitals keep family members informed during a patient’s surgery. See real-time updates on your loved one’s progress without needing to ask staff.”
          </p>
          <div className='flex justify-center items-center gap-10 h-[50vh]'>
            ...
            cursor-pointer hover:shadow-lg transition'
              onClick={() => navigate('/login')}
            >
              <img src='/surgery-team.png' className='w-5/6 h-auto object-cover' />
